return {
    {
        ...
        config = function()
            ...
            if textobjects_ok then
                ...
                for _, mode in ipairs({ 'x', 'o' }) do
                    vim.keymap.set(mode, 'aa', function()
                        textobjects.select.select_textobject('@parameter.outer', 'textobjects')
                    end)
                    vim.keymap.set(mode, 'ia', function()
                        textobjects.select.select_textobject('@parameter.inner', 'textobjects')
                    end)
                ...
                for _, mode in ipairs({ 'n', 'x', 'o' }) do
                    ...
                    vim.keymap.set(mode, '[]', function()
                        textobjects.move.goto_previous_end('@class.outer', 'textobjects')
                    end)
                end
            ...
            vim.keymap.set('n', '<c-space>', 'v<cmd>lua vim.treesitter.select_increment()<cr>')
            vim.keymap.set('v', '<c-space>', '<cmd>lua vim.treesitter.select_increment()<cr>')
            vim.keymap.set('v', '<c-backspace>', '<cmd>lua vim.treesitter.select_decrement()<cr>')
        end,
    },
}
